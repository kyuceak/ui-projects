...
function PracticalForm({
  ...
  return (
    <form action="" className="practical-form">
      ...
      <div className="actions">
        <button
          onClick={() => {
            setEditingId(null);
            return removeWorkExperience(work.id);
          }}
          id="del-btn"
        >
          <span>
        ...
        <button onClick={handleSave} id="save-btn">
          Save
        </button>
...
function PracticalExperienceForm({ workExperience, setWorkExperience }) {
  ...
  const updateWorkExperience = (updatedWork) => {
    setWorkExperience(
    ...
    <>
      ...
      <div className="education-container">
        ...
        <div className="practical-forms">
          {
            //list work experiences or show the currente editing work
            workExperience.map((work) =>
              editingId === work.id ? (
                <PracticalForm
                  key={work.id}
        ...
        <button className="pls-btn" onClick={addWorkExperience}>
          <svg
            viewBox="0 -0.5 21 21"
            version="1.1"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="pls-text">Experience</span>
        </button>
      </div>
    </>
  );
